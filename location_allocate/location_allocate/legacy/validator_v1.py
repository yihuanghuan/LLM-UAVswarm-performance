...
def _schema_candidates() -> List[Path]:
    ...
    candidates.extend(
        [
            here.parents[3] / "schemas" / "legacy" / "lfs_schema_v1.json",
            here.parents[4] / "schemas" / "legacy" / "lfs_schema_v1.json",
            Path.cwd() / "schemas" / "legacy" / "lfs_schema_v1.json",
            Path.cwd().parent / "schemas" / "legacy" / "lfs_schema_v1.json",
        ]
    )
    ...
    try:
        ...
        candidates.append(
            share_dir / "schemas" / "legacy" / "lfs_schema_v1.json"
        )
    except Exception:
        pass
