...
TRAJECTORY_METRICS_CSV_FIELDS = [
    ...
    "motion_style",
    "trajectory_profile",
    "ladrc_accel_feedforward_enabled",
    "safety_factor",
    "path_length",
    "max_velocity",
    "max_acceleration",
    ...
    "integrated_squared_jerk",
    "max_velocity_valid",
    "max_acceleration_valid",
    "max_jerk_valid",
    "integrated_squared_jerk_valid",
    "elapsed_time",
    "arrival_time_error",
    "final_position_error",
    "tracking_error",
    ...
    "actual_velocity_y",
    "actual_velocity_z",
    "ladrc_acceleration_command_x",
    "ladrc_acceleration_command_y",
    "ladrc_acceleration_command_z",
    "is_finished",
    "is_hover_stable",
]
