...
SOURCE='36dba68c6b16681ec98500b49c5a83095de4b634'; BASELINE_TAG='paper-final-sim-v3'; BASELINE='6cf402debf23851b1eff3edc6f3ab49eae7127c4'; BRANCH='formal/E5-end-to-end-v1'
...
def validate():
 ...
 return {'manifest_type':'E5_provenance_v1','status':'PASS' if all(c['status']=='PASS' for c in cs) else 'FAIL','runner_branch':BRANCH,'runner_commit':head,'checks':cs}
