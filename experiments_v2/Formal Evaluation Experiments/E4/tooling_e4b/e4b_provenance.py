...
SOURCE='36dba68c6b16681ec98500b49c5a83095de4b634'; BASELINE_TAG='paper-final-sim-v3'; BASELINE='6cf402debf23851b1eff3edc6f3ab49eae7127c4'; BRANCHES={'formal/E4B-authority-preservation-v1','formal/E4B-formal-adapter-v1'}; PRODUCTION=['location_allocate/location_allocate/timing_resolution.py','location_allocate/location_allocate/motion_limits.py','location_allocate/location_allocate/execution_profile_compiler.py','location_allocate/location_allocate/safety_aware_allocator.py','lfs_policy/config/lfs_policy.paper_current.yaml']
...
def validate():
 ...
 return {'manifest_type':'E4B_provenance_v1','status':'PASS' if all(c['status']=='PASS' for c in cs) else 'FAIL','runner_branch':branch if 'branch' in locals() else 'UNKNOWN','runner_commit':head,'checks':cs}
