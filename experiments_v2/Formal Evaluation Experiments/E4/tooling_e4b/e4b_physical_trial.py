...
def orchestrate(spec,output,result):
 ...
 try:
  ...
  out['attempt_status']='success';out['raw_evidence']={'rosbag':'rosbag','staging':'stage_result.json','interaction':'interaction_result.json','controllers':'controllers.log','authority_runtime_spec':'runtime_spec.json'}
