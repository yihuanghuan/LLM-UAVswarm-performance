...
def test_complete_synthetic_trial(tmp_path):
    metadata = {
        "experiment_id": "synthetic", "batch_id": "test", "phase": "main",
            "scenario": "synthetic", "method": "Full", "trial": 1, "seed": 42,
            "assignment_mode": "distance_hungarian",
            "avoidance_mode": "iapf_dual",
            "assignment_metrics": {
                "xy_crossings": 1, "proximity_crossings": 1,
                "min_distance": 0.0, "distance": 4.0, "iterations": 0,
            },
        "safety_thresholds": {
    ...
    assert summary["safety_success"] is False
