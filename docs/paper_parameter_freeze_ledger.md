...
| `d_hard` / violation distance | `1.50 m` | `FROZEN` | C0-D | `16953f23…` | — | `C0-D_safety_policy_freeze/frozen_safety_policy.yaml` (SHA-256 `901bc588…`) and component manifest | Planning-safety component value; system hard-risk threshold does not scale with `s`. Full-runtime integration is deferred to C0-E. |
